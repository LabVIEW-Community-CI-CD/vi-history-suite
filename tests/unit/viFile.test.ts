...
describe('viFile', () => {
  it('returns only the bytes actually read up to the minimum header length', async () => {
  ...
  it('fails closed to undefined when the filesystem signature probe cannot be completed', async () => {
    await expect(
