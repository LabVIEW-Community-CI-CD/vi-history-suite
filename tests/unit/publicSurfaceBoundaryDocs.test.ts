...
describe('public facade boundary docs', () => {
  it('keeps the public source publication boundary explicit after the v1.3.14 source/tag handoff', () => {
    ...
    expect(publicSourceLedger).toContain('Current published public GitHub source HEAD: `f1cb609`');
    ...
    expect(publicSourceLedger).toContain('Public GitHub release publication: not performed');
    ...
    expect(publicSourceLedgerJson).toContain('"publishedHeadCommit": "f1cb609"');
