...
describe('windows private release packet docs', () => {
  it('retains the tracked Windows-only private-release packet and links it into the control plane', () => {
    ...
    expect(packetDoc).toContain('feature/windows-private-release-publication-governance');
    ...
    expect(packetJson.packageEvidence.sizeBytes).toBe(501486);
    expect(packetJson.publication).toEqual({
      ...
      sourceBranch: 'feature/windows-private-release-publication-governance',
      sourceCommit: '7f7a6c85cf476d2454ada2464704a4b82c2de921',
      vsixDirectAssetUrl:
