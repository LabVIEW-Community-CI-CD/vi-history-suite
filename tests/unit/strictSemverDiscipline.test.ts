...
describe('strict semver discipline', () => {
  it('keeps the published main line aligned to the current exact release line', () => {
    ...
    expect(versionLineContract.currentMainPackageLine).toBe('1.3.3');
    expect(versionLineContract.currentDevelopPackageLine).toBe('1.3.2');
    ...
    expect(versionLineContract.activeHotfixCandidateReleaseLine).toBe('v1.3.4');
    expect(versionLineContract.activeHotfixBranch).toBe('hotfix/v1.3.4-public-exact-retry');
    ...
    expect(readme).toContain('- current exact released line: `v1.3.3`');
    expect(readme).toContain('- current published package line on `main`: `1.3.3`');
    expect(readme).toContain('- current develop package line on `develop`: `1.3.2`');
    ...
    expect(readme).toContain('- active exact hotfix candidate line on `main`: `v1.3.4`');
    expect(readme).toContain('- active hotfix branch: `hotfix/v1.3.4-public-exact-retry`');
    ...
    expect(currentState).toContain('- current published package line on `main`: `1.3.3`');
    expect(currentState).toContain('- current develop package line on `develop`: `1.3.2`');
    ...
    expect(currentState).toContain('- active hotfix branch: `hotfix/v1.3.4-public-exact-retry`');
    ...
    expect(releaseProcedure).toContain('The current exact released line is `v1.3.3`.');
    expect(releaseProcedure).toContain('The burned exact released line is `v1.0.2`.');
    expect(releaseProcedure).toContain("The current published package line on `main` is `1.3.3`.");
    expect(releaseProcedure).toContain('The current develop package line on `develop` is `1.3.2`.');
    ...
    expect(releaseProcedure).toContain('The active exact hotfix candidate line on `main` is `v1.3.4`.');
    expect(releaseProcedure).toContain('The active hotfix branch is `hotfix/v1.3.4-public-exact-retry`.');
