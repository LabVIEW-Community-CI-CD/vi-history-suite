...
describe('ship-control direction system', () => {
  ...
  it('keeps the repo entrypoints and release procedure aligned to the ship-control surfaces', () => {
    ...
    expect(readme).toContain('- current develop package line on `develop`: `1.3.5`');
    ...
    expect(releaseProcedure).toContain("current develop package line on `develop` is `1.3.5`");
