...
describe('ship-control direction system', () => {
  ...
  it('keeps the repo entrypoints and release procedure aligned to the ship-control surfaces', () => {
    ...
    expect(readme).toContain('- retained exact-version releases: `v0.2.0`, `v1.0.0`, `v1.0.1`, `v1.0.2`, `v1.0.3`, `v1.0.4`, `v1.0.5`, `v1.0.6`, `v1.1.0`, `v1.2.0`, `v1.2.1`, `v1.2.2`, `v1.3.0`, `v1.3.1`, `v1.3.2`, `v1.3.3`, `v1.3.4`, `v1.3.5`');
    expect(readme).toContain('- burned exact release line: `v1.0.2`');
    expect(readme).toContain('- current exact released line: `v1.3.5`');
    expect(readme).toContain('- current published package line on `main`: `1.3.5`');
    expect(readme).toContain('- current develop package line on `develop`: `1.3.6`');
    expect(readme).toContain('- active exact release candidate line on `develop`: `v1.3.6`');
    expect(readme).toContain('- active release-candidate branch: `release/1.3.6`');
    ...
    expect(currentState).toContain('- active exact release candidate line on `develop`: `v1.3.6`');
    expect(currentState).toContain('- active release-candidate branch: `release/1.3.6`');
    ...
    expect(releaseProcedure).toContain('current exact released line is `v1.3.5`');
    expect(releaseProcedure).toContain('burned exact released line is `v1.0.2`');
    expect(releaseProcedure).toContain("current published package line on `main` is `1.3.5`");
    expect(releaseProcedure).toContain("current develop package line on `develop` is `1.3.6`");
    expect(releaseProcedure).toContain('active exact release candidate line on `develop` is `v1.3.6`');
    expect(releaseProcedure).toContain('The active release-candidate branch is `release/1.3.6`.');
    ...
    expect(changelog).toContain('## [1.3.6] - 2026-04-22');
