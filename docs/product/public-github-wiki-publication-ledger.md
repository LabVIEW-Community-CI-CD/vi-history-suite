...
- Current published public GitHub wiki HEAD: `2ecb847`
...
| Fork Codespace Quickstart | `Fork-Codespace-Quickstart` | published | `2026-04-06` | `2ecb847` | `README.md`; `docs/product/current-state.md`; `docs/product/execution-programs/PROGRAM-0002-public-facade-installer-and-windows-acceptance.md` |
| Manual Actor Framework Clone | `Manual-Actor-Framework-Clone` | published | `2026-04-06` | `2ecb847` | `README.md`; `docs/product/current-state.md`; `docs/product/execution-programs/PROGRAM-0002-public-facade-installer-and-windows-acceptance.md` |
