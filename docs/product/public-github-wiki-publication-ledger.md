...
- Current published public GitHub wiki HEAD: `1fb3a00`
...
| Install And Release | `Install-And-Release` | published | `2026-04-07` | `1fb3a00` | `README.md`; `docs/release-procedure.md`; `CHANGELOG.md` |
...
| Fork Codespace Quickstart | `Fork-Codespace-Quickstart` | published | `2026-04-07` | `1fb3a00` | `README.md`; `docs/product/current-state.md`; `docs/product/execution-programs/PROGRAM-0002-public-facade-installer-and-windows-acceptance.md` |
| Manual Actor Framework Clone | `Manual-Actor-Framework-Clone` | published | `2026-04-07` | `1fb3a00` | `README.md`; `docs/product/current-state.md`; `docs/product/execution-programs/PROGRAM-0002-public-facade-installer-and-windows-acceptance.md` |
