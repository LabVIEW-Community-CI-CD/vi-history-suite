...
- Current published public GitHub wiki HEAD: `fe3e11c`

## Published Pages

| Page | Wiki Path | Status | Published | Wiki Commit | Primary Authority |
| --- | --- | --- | --- | --- | --- |
| Overview | `Home` | published | `2026-04-06` | `2ecb847` | `README.md`; `docs/product/execution-programs/PROGRAM-0002-public-facade-installer-and-windows-acceptance.md`; `docs/release-procedure.md` |
...
| Install And Release | `Install-And-Release` | published | `2026-04-06` | `2ecb847` | `README.md`; `docs/release-procedure.md`; `CHANGELOG.md` |
...
| Fork Codespace Quickstart | `Fork-Codespace-Quickstart` | published | `2026-04-06` | `fe3e11c` | `README.md`; `docs/product/current-state.md`; `docs/product/execution-programs/PROGRAM-0002-public-facade-installer-and-windows-acceptance.md` |
| Manual Actor Framework Clone | `Manual-Actor-Framework-Clone` | published | `2026-04-06` | `fe3e11c` | `README.md`; `docs/product/current-state.md`; `docs/product/execution-programs/PROGRAM-0002-public-facade-installer-and-windows-acceptance.md` |
| Current State | `Current-State` | published | `2026-04-06` | `a7e30cd` | `README.md`; `docs/product/current-state.md`; `docs/product/extension-execution-policy.md` |
