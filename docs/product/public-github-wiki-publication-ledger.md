...
- Current published public GitHub wiki HEAD: `3ef5bee`
...
| Fork Codespace Quickstart | `Fork-Codespace-Quickstart` | published | `2026-04-07` | `3ef5bee` | `README.md`; `docs/product/current-state.md`; `docs/product/execution-programs/PROGRAM-0002-public-facade-installer-and-windows-acceptance.md` |
| Manual Actor Framework Clone | `Manual-Actor-Framework-Clone` | published | `2026-04-07` | `3ef5bee` | `README.md`; `docs/product/current-state.md`; `docs/product/execution-programs/PROGRAM-0002-public-facade-installer-and-windows-acceptance.md` |
