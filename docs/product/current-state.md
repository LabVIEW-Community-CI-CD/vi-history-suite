...
- `TRANCHE-012`: Post-release sustainment and release cadence
  ...
  - this tranche now owns long-tail release cadence, benchmark refresh cadence, operator-surface upkeep, and post-release control-plane maintenance after benchmark proof and execution-policy closeout both landed
