...
- `TRANCHE-012`: Post-release sustainment and release cadence
  ...
  - feature-layer extension execution flexibility and runtime-acquisition UX remain intentionally separated under `TRANCHE-013` / `PROGRAM-0005` instead of being absorbed into sustainment by implication
...
- closed and follow-on execution programs:
