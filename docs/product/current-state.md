...
25. [post-release-sustainment-rules.md](./post-release-sustainment-rules.md)
26. [post-release-sustainment-rules.json](./post-release-sustainment-rules.json)
27. [Extension Execution Policy](./extension-execution-policy.md)
28. [PROGRAM-0005: Extension Execution Flexibility And Runtime Acquisition UX](./execution-programs/PROGRAM-0005-extension-execution-flexibility-and-runtime-acquisition-ux.md)
...
27. [Extension Execution Policy](./extension-execution-policy.md)
28. [PROGRAM-0005: Extension Execution Flexibility And Runtime Acquisition UX](./execution-programs/PROGRAM-0005-extension-execution-flexibility-and-runtime-acquisition-ux.md)
29. [Fast VS Code Loop](../dev-fast-loop.md)
...
- `TRANCHE-011`: Repeatable Windows and Linux benchmark proof
  ...
  - `VHS-REQ-449` is now implemented for exact-pair diagnosis control: `runHarnessReportSmoke` rejects non-canonical selected/base hash bundles, incomplete engine/path overrides, wrong Windows executable basenames, and Windows bitness/path contradictions before a targeted diagnosis rerun can contaminate retained benchmark evidence
  ...
  - canonical runtime-override admission control is now shared across the full benchmark-proof control surface rather than one diagnosis entrypoint only, so dashboard-smoke, decision-record, exact-pair smoke, and the Windows/Linux benchmark CLIs all reject contradictory explicit runtime bundles before they can bias retained evidence
