...
- active execution program: [PROGRAM-0002: Public Facade Release Kit And Host-Machine Acceptance](./execution-programs/PROGRAM-0002-public-facade-installer-and-windows-acceptance.md)
  ...
  - the authority repo now mirrors its GitHub Linux benchmark lane into the private `vi-history-suite-source-experiments` repo for `HARNESS-VHS-002` / `resource/plugins/lv_icon.vi`, while GitLab remains the authority source repo and release-control surface
