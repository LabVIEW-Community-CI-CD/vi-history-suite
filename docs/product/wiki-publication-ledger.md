...
| Current State | `Current-State` | published | `2026-04-04` | `4e5d3f4` | `docs/product/current-state.md`; `README.md`; `docs/product/SHIP-0001-releasable-vi-history-suite.md`; `docs/product/development-queue.json`; `docs/product/blocker-ledger.json`; `docs/product/wiki-coverage-matrix.md` |
