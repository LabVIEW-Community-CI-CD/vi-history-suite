...
- Current published Marketplace version: `1.3.16`
- Current publication date: `2026-05-11`
- Current publication kind: exact release
- Current regular Marketplace version: `1.3.16`
- Current regular publication date: `2026-05-11`
...
- Marketplace published version: `1.3.13`
- Marketplace last updated: `2026-04-27T04:24:05.457Z`
...
| VS Code Marketplace exact release | published | `2026-05-11` | `1.3.16` | `pinned-vsce-cli` | `docs/product/release-publication-state.md`; `docs/product/public-release-candidate.md`; `docs/product/vscode-marketplace-publication-ledger.md`; public GitHub PR #88; GitHub release `v1.3.16`; Windows exact-VSIX install proof receipt |
