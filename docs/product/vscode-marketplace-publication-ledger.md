...
- Current published Marketplace version: `1.3.7`
...
- Pending publication prep status: published and verified; the retained
  production publication used the pinned `vsce` path for `1.3.7`
