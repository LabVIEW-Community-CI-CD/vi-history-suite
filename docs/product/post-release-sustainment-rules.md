...
`PROGRAM-0005` now retains the published `v1.3.16` host-default Windows local
...
- retained exact-version releases: `v0.2.0`, `v1.0.0`, `v1.0.1`, `v1.0.2`,
  ...
  `v1.3.6`, `v1.3.7`, `v1.3.8`, `v1.3.9`, `v1.3.14`, `v1.3.15`,
  `v1.3.16`
...
- current retained public GitHub exact verify gate:
  public release `320824958` is published on `v1.3.16`, release lookup by tag
...
- current publication incident history:
  ...
  Marketplace now serves `1.3.16`; blocker
  `published-immutable-release-assets-incomplete` is retained only as
  historical incident evidence while exact `v1.3.16` remains the current fully
  closed line
...
- rationale: authority exact `v1.3.16` remains tagged on `main`, public
  GitHub release `320824958` is retained as a complete immutable exact release,
  and VS Code Marketplace serves regular `1.3.16`
...
- rationale: blocked historical `v1.3.8` incident evidence remains retained,
  exact `v1.3.16` is now fully closed across GitLab authority, public GitHub,
  Windows exact-VSIX install proof, and VS Code Marketplace; patch candidate
  branches follow normal GitFlow and release branch deletion remains blocked
...
- recovery boundary:
  ...
  exact GitHub and VS Code Marketplace acts are fully closed for `v1.3.16`
...
- Marketplace prep rule:
  ...
  exact line it verifies the GitHub `v1.3.16` verify gate, exact
