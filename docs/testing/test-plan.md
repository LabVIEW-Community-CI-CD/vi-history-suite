...
Definition-of-Done governance, VI Server gate, registry-fallback, and Linux
container headless-recovery evidence branches, the baseline is 497/513
...
| --- | --- | --- |
| `exact-testable` | `VHS-REQ-624.9`, `VHS-REQ-641.3`, `VHS-REQ-641.5`, `VHS-REQ-650.7`, `VHS-REQ-659.7`, `VHS-REQ-659.12`, `VHS-REQ-659.15` | Close in focused PRs by surface: runtime remediation, staged-tree/runtime evidence, and VI Preview lifecycle. |
