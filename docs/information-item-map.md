...
| Runtime-provider public-acceptance gate | `docs/product/runtime-provider-public-acceptance-gate.md` | sole author | the next host-default installed-user publication boundary or public acceptance meaning changes | future sessions can see the open gate for the next published host-default contract without reopening the historical Docker-only public closeout |
| Machine-readable runtime-provider public-acceptance gate | `docs/product/runtime-provider-public-acceptance-gate.json` | sole author | the next host-default installed-user publication boundary or public acceptance meaning changes | automation and future sessions can recover the open gate state, historical closeout reference, and remaining admission criteria without scraping Markdown |
