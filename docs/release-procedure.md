...
- The current develop package line on `develop` is `1.3.12`.
...
- The active governed release claim is the `1.3.12` public validation
  pre-release with all provider/year/bitness variants selectable and Windows
  installed-user proof community/deferred.
- The active Marketplace public validation preview line is `1.3.12`.
...
- The active Marketplace public validation preview status is prepared and
  authorized for `1.3.12`, pending GitLab authority green before public
...
- The active public validation path is admitted for pre-release publication:
  ...
  canonical public fixture proof packet for `1.3.12`.
...
- The current published package line on `main` is `1.3.9`, and the current
  develop package line on `develop` is `1.3.12`; the closed exact line
  ...
  evidence.
- The current develop package line on `develop` is `1.3.12`, public GitHub
