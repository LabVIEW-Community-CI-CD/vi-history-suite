...
- The current exact released line is `v1.3.2`.
- The burned exact released line is `v1.0.2`.
- The current published package line on `main` is `1.3.2`.
...
- The active exact hotfix candidate line on `main` is `v1.3.3`.
- The active hotfix branch is `hotfix/v1.3.3-public-exact-retry`.
...
- The current published package line on `main` is `1.3.2`, tracked in
  ...
  `v1.2.2`, exact `v1.3.0`, exact `v1.3.1`, exact `v1.3.2`, or separate
  public GitHub exact `v1.3.1` release evidence.
- The current develop package line on `develop` is `1.3.1`, public GitHub
  ...
  Marketplace remains `1.3.0`, and `hotfix/v1.3.3-public-exact-retry` is the
  active hotfix lane for the stale public-source validation surfaces that
  blocked the public GitHub exact-release act from authority `v1.3.2`.
