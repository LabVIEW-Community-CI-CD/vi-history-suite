...
| exact released line | The currently published installed-user truth. In this repo, the current exact released line is `v1.2.2`. | choosing the correct workflow before compare or validation |
