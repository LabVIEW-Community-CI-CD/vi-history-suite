...
| --- | --- | --- |
| Assurance workbench | The published `repo-standards-review` container used for outer release-gate checks. | external `v0.2.13` baseline |
...
| released compliance workbench | The published `repo-standards-review` assurance-workbench image used as the outer standards-verification baseline. | `v0.2.13` intake and future `26514` branch validation |
