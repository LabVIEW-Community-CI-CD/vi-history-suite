...
| Evidence model | repo-native docs gate plus the released `repo-standards-review v0.2.12` compliance workbench and exact checker |

## Documentation Planning Inputs

| Input | Current retained decision |
| --- | --- |
| Standards source | released `repo-standards-review v0.2.12` plus truthful `vi-history-suite` authority surfaces |
...
- Release-facing quality evidence:
  ...
  - released `repo-standards-review v0.2.12` exact checker
  - released `repo-standards-review v0.2.12` compliance workbench release gate
