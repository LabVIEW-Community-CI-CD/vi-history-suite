...
- Run `npm run branch-protection:audit -- --all` when branch-protection settings are part of the question; it reads live `develop`/`main` protection through `gh` and fails if required checks or core protection flags drift.
