...
const OUT = path.join(__dirname, 'dataset', 'ollama-grounded-aggregate-eval.json');
...
async function main() {
  ...
  const report = {
    ...
    host: 'LINUX', backend: 'gpu', ollamaUrl: OLLAMA, model: MODEL, surface: 'pr-review-aggregate',
