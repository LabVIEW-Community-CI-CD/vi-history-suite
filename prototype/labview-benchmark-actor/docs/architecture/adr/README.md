...
| [ADR-0007](ADR-0007-image-derived-timing-binary-strip.md) | Image-derived timing binds to the OCR-robust binary strip; colon time is human-only | WIN | Accepted | LBA-REQ-003, LBA-REQ-005 |
