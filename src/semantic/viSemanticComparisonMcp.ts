...
/** Every resource URI published by the registry (the authoritative known set). */
const KNOWN_RESOURCE_URIS: ReadonlySet<string> = new Set(
  VI_SEMANTIC_MCP_RESOURCES.map((resource) => resource.uri)
);
